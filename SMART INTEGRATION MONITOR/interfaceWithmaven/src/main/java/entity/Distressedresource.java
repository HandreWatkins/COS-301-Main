...
@NamedQueries({@NamedQuery(name="Distressedresource.findAll", query="SELECT d FROM Distressedresource d ORDER BY d.distressedresourcesId DESC"),
@NamedQuery(name="Distressedresource.findTIMER", query="SELECT d FROM Distressedresource d WHERE d.lastUpdate<= :last_update ORDER BY d.distressedresourcesId DESC")
})
